...
pyxel.load("design.4.pyxres", True, False, False, False)
...
####################################
def update():
    global player, ennemis_liste, commencer, difficulte_choisie, score, vies, tirs_liste, objets_liste, max_score
...
def draw():
    ...
    if commencer == 0:
        ...
        #Score
        pyxel.text(0, 12, f"Score: {score}", 7)
    ...
    #Écran GAME OVER
        ...
        pyxel.text(dimension_ecran/2 - 23, dimension_ecran/2 + 14, f" Max score: {max_score}", 7)        
####################################
